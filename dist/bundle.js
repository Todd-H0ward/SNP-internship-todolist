...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   clearActiveButton: () => (/* binding */ clearActiveButton),\n/* harmony export */   render: () => (/* binding */ render),\n/* harmony export */   renderTask: () => (/* binding */ renderTask),\n/* harmony export */   updateTaskClasses: () => (/* binding */ updateTaskClasses),\n/* harmony export */   updateTaskElement: () => (/* binding */ updateTaskElement),\n/* harmony export */   updateTasksCount: () => (/* binding */ updateTasksCount)\n/* harmony export */ });\n/* harmony import */ var _main__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./main */ \"./src/js/main.js\");\n/* harmony import */ var _domElements__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./domElements */ \"./src/js/domElements.js\");\n/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./utils */ \"./src/js/utils.js\");\n/* harmony import */ var _handlers__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./handlers */ \"./src/js/handlers.js\");\n\n\n\n\n\nconst updateTasksCount = () => {\n    const activeTasksCount = _main__WEBPACK_IMPORTED_MODULE_0__.tasks.filter((task) => task.isActive).length;\n    _domElements__WEBPACK_IMPORTED_MODULE_1__.controlsNumber.textContent = String(activeTasksCount);\n    _domElements__WEBPACK_IMPORTED_MODULE_1__.controls.style.display = _main__WEBPACK_IMPORTED_MODULE_0__.tasks.length === 0 ? \"none\" : \"grid\";\n    _domElements__WEBPACK_IMPORTED_MODULE_1__.arrowButton.style.display = _main__WEBPACK_IMPORTED_MODULE_0__.tasks.length === 0 ? \"none\" : \"block\";\n    _domElements__WEBPACK_IMPORTED_MODULE_1__.clearButton.classList.toggle(\"hidden\", activeTasksCount === _main__WEBPACK_IMPORTED_MODULE_0__.tasks.length);\n};\n\nconst updateTaskElement = (elem, taskId) => {\n    const taskData = _main__WEBPACK_IMPORTED_MODULE_0__.tasks.find((task) => task.id === taskId);\n    taskData.isActive = !taskData.isActive;\n\n    if ((0,_utils__WEBPACK_IMPORTED_MODULE_2__.satisfyFilter)(taskData, _main__WEBPACK_IMPORTED_MODULE_0__.filter)) {\n        elem.className = \"task\";\n        updateTaskClasses(elem, taskData.isActive);\n    } else {\n        elem?.remove();\n    }\n\n    updateTasksCount();\n    (0,_utils__WEBPACK_IMPORTED_MODULE_2__.saveTasks)();\n};\n\nconst renderTask = (task) => {\n    const template = _domElements__WEBPACK_IMPORTED_MODULE_1__.taskTemplate.content.cloneNode(true);\n    const taskElem = template.querySelector(\".task\");\n    const taskCheckbox = taskElem.querySelector(\".task__checkbox\");\n    const taskBtn = taskElem.querySelector(\".task__btn\");\n    const taskTitle = taskElem.querySelector(\".task__title\");\n\n    taskCheckbox.checked = !task.isActive;\n    taskTitle.textContent = task.title;\n    taskElem.dataset.id = task.id;\n    taskElem.classList.toggle(\"task--finished\", !task.isActive);\n\n    const handleTaskBtnClick = () => (0,_handlers__WEBPACK_IMPORTED_MODULE_3__.handleTaskDelete)(taskElem, task.id);\n    const handleTaskTitleClick = () => (0,_handlers__WEBPACK_IMPORTED_MODULE_3__.handleTitleChange)(taskTitle, task.id);\n    const handleTaskTitleTouch = () => (0,_handlers__WEBPACK_IMPORTED_MODULE_3__.handleTitleChange)(taskTitle, task.id);\n    const handleTaskCheckboxChange = (event) => {\n        updateTaskElement(taskElem, task.id);\n        (0,_utils__WEBPACK_IMPORTED_MODULE_2__.makeOutline)(taskElem, event.target);\n    };\n\n    taskBtn.addEventListener(\"click\", handleTaskBtnClick);\n    taskTitle.addEventListener(\"dblclick\", handleTaskTitleClick);\n    taskTitle.addEventListener(\"touch\", handleTaskTitleTouch);\n    taskCheckbox.addEventListener(\"change\", handleTaskCheckboxChange);\n\n    _domElements__WEBPACK_IMPORTED_MODULE_1__.tasksWrapper.appendChild(taskElem);\n};\n\nconst render = (filter) => {\n    _domElements__WEBPACK_IMPORTED_MODULE_1__.tasksWrapper.innerHTML = \"\";\n    const filteredTasks = (0,_utils__WEBPACK_IMPORTED_MODULE_2__.getFilteredTasks)(filter);\n    filteredTasks.forEach((task) => renderTask(task));\n    updateTasksCount();\n    (0,_utils__WEBPACK_IMPORTED_MODULE_2__.saveTasks)();\n};\n\nconst clearActiveButton = () => {\n    _domElements__WEBPACK_IMPORTED_MODULE_1__.filterButtons.forEach((btn) => btn.classList.remove(\"button--active\"));\n};\n\nconst updateTaskClasses = (taskElem, isActive) => {\n    const closestTask = taskElem.closest(\".task\");\n    closestTask.classList.toggle(\"task--finished\", !isActive);\n};\n\n\n//# sourceURL=webpack://todo/./src/js/domUtils.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   addTask: () => (/* binding */ addTask),\n/* harmony export */   addTaskOnEnter: () => (/* binding */ addTaskOnEnter),\n/* harmony export */   handleClearFinished: () => (/* binding */ handleClearFinished),\n/* harmony export */   handleClickOutsideTaskInput: () => (/* binding */ handleClickOutsideTaskInput),\n/* harmony export */   handleFilterSelection: () => (/* binding */ handleFilterSelection),\n/* harmony export */   handleTaskDelete: () => (/* binding */ handleTaskDelete),\n/* harmony export */   handleTitleChange: () => (/* binding */ handleTitleChange),\n/* harmony export */   handleToggleAll: () => (/* binding */ handleToggleAll),\n/* harmony export */   saveTaskTitle: () => (/* binding */ saveTaskTitle)\n/* harmony export */ });\n/* harmony import */ var _domElements__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./domElements */ \"./src/js/domElements.js\");\n/* harmony import */ var _main__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./main */ \"./src/js/main.js\");\n/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./utils */ \"./src/js/utils.js\");\n/* harmony import */ var _domUtils__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./domUtils */ \"./src/js/domUtils.js\");\n\n\n\n\n\nconst addTask = () => {\n    const inputValue = _domElements__WEBPACK_IMPORTED_MODULE_0__.input.value.trim();\n    if (inputValue) {\n        const task = {\n            id: Date.now(),\n            title: inputValue,\n            isActive: true,\n        };\n        _main__WEBPACK_IMPORTED_MODULE_1__.tasks.push(task);\n        _domElements__WEBPACK_IMPORTED_MODULE_0__.input.value = \"\";\n        if ((0,_utils__WEBPACK_IMPORTED_MODULE_2__.satisfyFilter)(task, _main__WEBPACK_IMPORTED_MODULE_1__.filter)) (0,_domUtils__WEBPACK_IMPORTED_MODULE_3__.renderTask)(task);\n        (0,_utils__WEBPACK_IMPORTED_MODULE_2__.saveTasks)();\n        (0,_domUtils__WEBPACK_IMPORTED_MODULE_3__.updateTasksCount)();\n    }\n};\n\nconst handleClickOutsideTaskInput = (event) => {\n    if (!_domElements__WEBPACK_IMPORTED_MODULE_0__.todosWrapper.contains(event.target)) addTask();\n};\n\nconst addTaskOnEnter = (event) => {\n    if (event.key === \"Enter\") addTask();\n};\n\nfunction handleFilterSelection() {\n    const filterValue = this.dataset.filter;\n    (0,_domUtils__WEBPACK_IMPORTED_MODULE_3__.clearActiveButton)();\n    this.classList.add(\"button--active\");\n    (0,_domUtils__WEBPACK_IMPORTED_MODULE_3__.render)(filterValue);\n    (0,_domUtils__WEBPACK_IMPORTED_MODULE_3__.updateTasksCount)();\n    (0,_main__WEBPACK_IMPORTED_MODULE_1__.setFilter)(filterValue);\n    (0,_utils__WEBPACK_IMPORTED_MODULE_2__.saveTasks)();\n}\n\nconst handleTaskDelete = (elem, taskId) => {\n    (0,_main__WEBPACK_IMPORTED_MODULE_1__.setTasks)(_main__WEBPACK_IMPORTED_MODULE_1__.tasks.filter((task) => task.id !== taskId));\n    elem?.remove();\n    (0,_domUtils__WEBPACK_IMPORTED_MODULE_3__.updateTasksCount)();\n    (0,_utils__WEBPACK_IMPORTED_MODULE_2__.saveTasks)();\n};\n\nconst handleTitleChange = (elem, taskId) => {\n    const taskData = _main__WEBPACK_IMPORTED_MODULE_1__.tasks.find((task) => task.id === taskId);\n\n    (0,_utils__WEBPACK_IMPORTED_MODULE_2__.makeSelection)(elem);\n    (0,_domUtils__WEBPACK_IMPORTED_MODULE_3__.updateTaskClasses)(elem, true);\n\n    elem.addEventListener(\"focusout\", () => saveTaskTitle(elem, taskData));\n    elem.addEventListener(\"keydown\", (event) => {\n        if (event.key === \"Enter\") {\n            saveTaskTitle(elem, taskData);\n        } else if (event.key === \"Escape\") {\n            elem.textContent = taskData.title;\n            (0,_utils__WEBPACK_IMPORTED_MODULE_2__.clearSelection)(elem);\n        }\n    });\n};\n\nconst saveTaskTitle = (elem, task) => {\n    const title = elem.textContent.trim();\n    (0,_utils__WEBPACK_IMPORTED_MODULE_2__.clearSelection)(elem);\n\n    if (title.length === 0) {\n        elem.textContent = task.title;\n    } else {\n        elem.textContent = title;\n        task.title = title;\n        (0,_domUtils__WEBPACK_IMPORTED_MODULE_3__.updateTaskClasses)(elem, task.isActive);\n    }\n\n    (0,_utils__WEBPACK_IMPORTED_MODULE_2__.saveTasks)();\n};\n\nconst handleClearFinished = () => {\n    (0,_main__WEBPACK_IMPORTED_MODULE_1__.setTasks)(_main__WEBPACK_IMPORTED_MODULE_1__.tasks.filter((task) => task.isActive));\n    (0,_domUtils__WEBPACK_IMPORTED_MODULE_3__.render)(_main__WEBPACK_IMPORTED_MODULE_1__.filter);\n};\n\nconst handleToggleAll = () => {\n    const isAllActive = _main__WEBPACK_IMPORTED_MODULE_1__.tasks.some((task) => task.isActive);\n    _main__WEBPACK_IMPORTED_MODULE_1__.tasks.forEach((task) => (task.isActive = !isAllActive));\n    (0,_domUtils__WEBPACK_IMPORTED_MODULE_3__.render)(_main__WEBPACK_IMPORTED_MODULE_1__.filter);\n    (0,_domUtils__WEBPACK_IMPORTED_MODULE_3__.updateTasksCount)();\n};\n\n\n//# sourceURL=webpack://todo/./src/js/handlers.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   filter: () => (/* binding */ filter),\n/* harmony export */   setFilter: () => (/* binding */ setFilter),\n/* harmony export */   setTasks: () => (/* binding */ setTasks),\n/* harmony export */   tasks: () => (/* binding */ tasks)\n/* harmony export */ });\n/* harmony import */ var _scss_main_scss__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../scss/main.scss */ \"./src/scss/main.scss\");\n/* harmony import */ var _handlers__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./handlers */ \"./src/js/handlers.js\");\n/* harmony import */ var _domElements__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./domElements */ \"./src/js/domElements.js\");\n/* harmony import */ var _domUtils__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./domUtils */ \"./src/js/domUtils.js\");\n/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./utils */ \"./src/js/utils.js\");\n\n\n\n\n\n\nlet { filter, tasks } = (0,_utils__WEBPACK_IMPORTED_MODULE_4__.loadTasks)();\n\nconst setTasks = (newTasks) => (tasks = newTasks);\nconst setFilter = (newFilter) => (filter = newFilter);\n\n_domElements__WEBPACK_IMPORTED_MODULE_2__.arrowButton.addEventListener(\"click\", _handlers__WEBPACK_IMPORTED_MODULE_1__.handleToggleAll);\n_domElements__WEBPACK_IMPORTED_MODULE_2__.clearButton.addEventListener(\"click\", _handlers__WEBPACK_IMPORTED_MODULE_1__.handleClearFinished);\nwindow.addEventListener(\"click\", _handlers__WEBPACK_IMPORTED_MODULE_1__.handleClickOutsideTaskInput);\n_domElements__WEBPACK_IMPORTED_MODULE_2__.input.addEventListener(\"keydown\", _handlers__WEBPACK_IMPORTED_MODULE_1__.addTaskOnEnter);\n\n_domElements__WEBPACK_IMPORTED_MODULE_2__.filterButtons.forEach((btn) =>\n    btn.addEventListener(\"click\", _handlers__WEBPACK_IMPORTED_MODULE_1__.handleFilterSelection),\n);\n\nif (tasks.length !== 0) {\n    (0,_domUtils__WEBPACK_IMPORTED_MODULE_3__.clearActiveButton)();\n    _domElements__WEBPACK_IMPORTED_MODULE_2__.todosFilter\n        .querySelector(`[data-filter=\"${filter}\"]`)\n        .classList.add(\"button--active\");\n    (0,_domUtils__WEBPACK_IMPORTED_MODULE_3__.render)(filter);\n    (0,_domUtils__WEBPACK_IMPORTED_MODULE_3__.updateTasksCount)();\n}\n\n\n//# sourceURL=webpack://todo/./src/js/main.js?");
