...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   addTask: () => (/* binding */ addTask),\n/* harmony export */   handleClearFinished: () => (/* binding */ handleClearFinished),\n/* harmony export */   handleTaskDelete: () => (/* binding */ handleTaskDelete),\n/* harmony export */   handleTitleChange: () => (/* binding */ handleTitleChange),\n/* harmony export */   handleToggleAll: () => (/* binding */ handleToggleAll),\n/* harmony export */   saveTaskTitle: () => (/* binding */ saveTaskTitle)\n/* harmony export */ });\n/* harmony import */ var _domUtils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./domUtils */ \"./src/js/domUtils.js\");\n/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./utils */ \"./src/js/utils.js\");\n/* harmony import */ var _main__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./main */ \"./src/js/main.js\");\n\n\n\n\nconst addTask = () => {\n    const inputValue = _main__WEBPACK_IMPORTED_MODULE_2__.input.value.trim();\n    if (inputValue) {\n        const task = {\n            id: Date.now(),\n            title: inputValue,\n            isActive: true,\n        };\n        _main__WEBPACK_IMPORTED_MODULE_2__.tasks.push(task);\n        _main__WEBPACK_IMPORTED_MODULE_2__.input.value = \"\";\n        if ((0,_utils__WEBPACK_IMPORTED_MODULE_1__.satisfyFilter)(task, _main__WEBPACK_IMPORTED_MODULE_2__.filter)) (0,_domUtils__WEBPACK_IMPORTED_MODULE_0__.renderTask)(task);\n        (0,_main__WEBPACK_IMPORTED_MODULE_2__.saveTasks)();\n        (0,_domUtils__WEBPACK_IMPORTED_MODULE_0__.updateTasksCount)();\n    }\n};\n\nconst handleTaskDelete = (elem, taskId) => {\n    (0,_main__WEBPACK_IMPORTED_MODULE_2__.setTasks)(_main__WEBPACK_IMPORTED_MODULE_2__.tasks.filter((task) => task.id !== taskId));\n    elem?.remove();\n    (0,_domUtils__WEBPACK_IMPORTED_MODULE_0__.updateTasksCount)();\n    (0,_main__WEBPACK_IMPORTED_MODULE_2__.saveTasks)();\n};\n\nconst handleTitleChange = (elem, taskId) => {\n    const taskData = _main__WEBPACK_IMPORTED_MODULE_2__.tasks.find((task) => task.id === taskId);\n\n    (0,_utils__WEBPACK_IMPORTED_MODULE_1__.makeSelection)(elem);\n    (0,_domUtils__WEBPACK_IMPORTED_MODULE_0__.updateTaskClasses)(elem, true);\n\n    elem.addEventListener(\"focusout\", () => saveTaskTitle(elem, taskData));\n    elem.addEventListener(\"keydown\", (event) => {\n        if (event.key === \"Enter\") {\n            saveTaskTitle(elem, taskData);\n        } else if (event.key === \"Escape\") {\n            elem.textContent = taskData.title;\n            (0,_utils__WEBPACK_IMPORTED_MODULE_1__.clearSelection)(elem);\n        }\n    });\n};\n\nconst saveTaskTitle = (elem, task) => {\n    const title = elem.textContent.trim();\n    (0,_utils__WEBPACK_IMPORTED_MODULE_1__.clearSelection)(elem);\n\n    if (title.length === 0) {\n        elem.textContent = task.title;\n    } else {\n        elem.textContent = title;\n        task.title = title;\n        (0,_domUtils__WEBPACK_IMPORTED_MODULE_0__.updateTaskClasses)(elem, task.isActive);\n    }\n\n    (0,_main__WEBPACK_IMPORTED_MODULE_2__.saveTasks)();\n};\n\nconst handleClearFinished = () => {\n    (0,_main__WEBPACK_IMPORTED_MODULE_2__.setTasks)(_main__WEBPACK_IMPORTED_MODULE_2__.tasks.filter((task) => task.isActive));\n    (0,_domUtils__WEBPACK_IMPORTED_MODULE_0__.render)(_main__WEBPACK_IMPORTED_MODULE_2__.filter);\n};\n\nconst handleToggleAll = () => {\n    const isAllActive = _main__WEBPACK_IMPORTED_MODULE_2__.tasks.some((task) => task.isActive);\n    _main__WEBPACK_IMPORTED_MODULE_2__.tasks.forEach((task) => (task.isActive = !isAllActive));\n    (0,_domUtils__WEBPACK_IMPORTED_MODULE_0__.render)(_main__WEBPACK_IMPORTED_MODULE_2__.filter);\n    (0,_domUtils__WEBPACK_IMPORTED_MODULE_0__.updateTasksCount)();\n};\n\n\n//# sourceURL=webpack://todo/./src/js/handlers.js?");
